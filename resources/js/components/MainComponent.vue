  ...
  <div class="container" style="padding-bottom: 0;">
    ...
    <div class="row">
      <div class="col-md-6 d-flex flex-column align-items-center">
        <img width="250" src="/img/logo-main.png" alt="logo">
        <div class="d-flex flex-column text-center">
          ...
          <div class="d-flex justify-content-center mt-4">
            <a href="#">
            <img width="70" src="/img/instagram.png" alt="instagram">
            </a>
            <a href="#">
            <img width="70" src="/img/facebook.png" alt="facebook">
            </a>
          </div>
        </div>
      </div>
      <div class="col-md-6 d-flex justify-content-center">
        <img style="max-width:100%" width="620" src="/img/producto.png" alt="producto">
      </div>
